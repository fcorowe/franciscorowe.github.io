...
weight: 2
title: "Introduction"
subtitle: "R Notebooks + Basic Functions + Data Types"
...
The content of this notebook is based on the following references:
...
![Fig. 1. RStudio features.](../sp/figs/rstudio_features.png)
...
![Fig. 2. YAML metadata for notebooks.](../sp/figs/rnotebook_yaml.png)
...
![Fig. 3. Code chunk example. Details on the various options: https://rmarkdown.rstudio.com/lesson-3.html](../sp/figs/codechunk.png)
...
```{r}
census <- read.csv("../sp/data/census_data.csv")
head(census)
...
```{r}
# read data
census2 <- read.csv("../sp/data/census_data2.csv")
...
## Read Spatial Data
```{r}
oa_shp <- st_read("../sp/data/Liverpool_OA.shp")
```
...
msoa_shp <- st_read("../sp/data/Liverpool_MSOA.shp")
